...
*NgheGo* là nền tảng học Tiếng Anh trực tuyến cho phép người dùng luyện nghe và gõ chính tả (Dictation) thông qua các video YouTube thực tế. Thay vì sử dụng nội dung học thuật khô khan, NgheGo tận dụng kho nội dung phong phú từ YouTube: Âm nhạc, bài giảng, podcast ... Để tạo ra trải nghiệm học tập tự nhiên, và hiệu quả.

Người dùng có thể dán link YouTube bất kỳ hoặc chọn từ thư viện video được phân loại theo trình độ CEFR (A1 đến C2). Hệ thống sẽ lấy Transcript, tách thành từng câu, cho phép người học lắng nghe, gõ lại và nhận phản hồi tức thì. Không yêu cầu đăng nhập, giảm thiểu rào cản cho mọi đối tượng.

#callout(
  "Điểm khác biệt cốt lõi",
  [NgheGo sử dụng *Vercel Workflow SDK* để xử lý video bất đồng bộ, lấy Transcript, phân tích độ khó, phân loại chủ đề và lưu vào database. Người dùng có thể dán bất kỳ link YouTube nào và bắt đầu luyện tập trong vài giây. Toàn bộ hệ thống được thiết kế tuân thủ *WCAG 2.2 cấp AA*, đảm bảo người học khuyết tật có thể tiếp cận đầy đủ các tính năng.],
  accent: rgb("#1e40af"),
)
...
#grid(
  ...
  block(
    ...
    *Mục tiêu giáo dục*
    #v(4pt)
    - Cải thiện kỹ năng nghe và gõ Tiếng Anh
...
+ *Người dùng khuyết tật*: Bao gồm người khiếm thị (sử dụng trình đọc màn hình), người khiếm thính và người hạn chế vận động (điều hướng bằng bàn phím hoặc thiết bị thay thế).
...
- Xác thực đăng nhập sử dụng Google OAuth, người dùng có thể luyện tập mà không cần đăng nhập
...
- HTML semantic: `<main>`, `<nav>`, `<section>`, `<header>`, `<footer>` được dùng đúng ngữ nghĩa
